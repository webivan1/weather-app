...
export const fetchForecastWeather = (): Promise<ForecastWeatherResponseType> =>
  fetch(`http://api.openweathermap.org/data/2.5/forecast?q=London,UK&appid=${API_KEY}&units=metric`)
